...
class parse_pindel(luigi.Task):
	...
	def run(self):
		...
		misc_utils.format_pindel(pindel_files=[input_file.path for input_file in self.input()], sample_dict=sample_dict, project_dir=self.project_dir, all_samples_output=self.output()[-1].path)
