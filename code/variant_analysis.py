...
class msings_baseline(luigi.Task):
	...
	def run(self):
		...
		cmd = ['./packages/msings/scripts/create_baseline.sh', normal_bams_file, './packages/MANTIS/b37_1000_ms_loci_annotated.msi_intervals', './packages/MANTIS/b37_1000_ms_loci_annotated.sorted.bed', self.cfg['fasta_file'], os.path.join(self.project_dir, 'output', 'msings', 'baseline')]
		pipeline_utils.command_call(cmd, self.output())
